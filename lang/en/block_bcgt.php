...
$string['descalevelusefa'] = 'Use Formal Assessments to record distinct Grading/Assessments for students. These are used separately from general assignments/homeworks/activities. FA\'s are grades inputted by teachers';
...
$string['labelshowtargetgrades'] = 'Use Target Grades';
...
$string['labelalpscrontime'] = 'Alps Report Cron run Time';
$string['descalpscrontime'] = 'This is the time, if you are using Alps, that the cron will generate the scores and coefficients';

$string['labelshowarchivegriddata'] = 'Show Archived Grid Data (Alevels Only)';
$string['descshowarchivegriddata'] = 'Enable/Disable the archived data from showing up on the Alevel grids. This is used to show AS data when the student has moved to an A2.';
...
$string['adminpluginsettings'] = 'Admin Plugin Settings';
...
$string['alevelqualsettings'] = 'Alevel Grade Settings';
$string['allqualifications'] = 'All Qualifications';
$string['alvlvalenience'] = '(A Level) Value Added Lenience';
$string['alvlvalenience:desc'] = 'This allows you to set a leniency score to be taken into account when calculated value added. For example if Target Grade was B (ranking: 5.0) and CETA was B/C (4.6) that would show up as BEHIND TARGET. However if you put in a leniency score of 0.4 then it will check if the difference is <= 0.4, and if so, say they are ON TARGET. So a B target and a B/C CETA would equate to ON TARGET.';
...
$string['asptargetgrade:desc'] = 'This is the target grade you should be aspiring to reach';
...
$string['bcgt:archivestudentdata'] = 'Create archive records for data.';
...
$string['bcgt:confirmreadcomments'] = 'Confirm you have read the unit comments';
...
$string['bycourse'] = 'By Course/Category';
...
$string['byregistergroup'] = 'By Register Group';
...
$string['calcasptargetgrade'] = 'Calculate Aspirational Target Grade';
...
$string['changeshowunitgroups'] = 'Show only units from group...';
...
$string['editassessment'] = 'Edit Assessments';
...
$string['edituserquals'] = 'Edit Users Qualifications';
...
$string['grade'] = 'Grade';
$string['gradegc'] = 'Grade (G/C)';
$string['gradetracker'] = 'Grade Tracker V7';
$string['gradetracker2'] = 'Grade Tracker';
...
$string['gridselectregister'] = 'Select a Register Grid';
...
$string['help'] = 'Help';
$string['historicalqualifications'] = 'Historical Qualifications';
...
//M
$string['managefagrades'] = 'Manage Formal Assessment Grades';
$string['managefagradeshelp'] = 'Select which grades can be selected when entering grades for formal assessment. Please note that the CETA grades are the Target Grades for the qualifications.';
...
$string['mlmodgradingscalefname'] = 'Module `Grading Scale ID` DB Column Name';
$string['mlgradeuserfname'] = 'Grade `User ID` DB Column Name';
...
$string['mlgradetablename'] = 'Grade table name';
$string['mlgradetimefname'] = 'Grade `Time` DB Column Name';
$string['mlgradegradefname'] = 'Grade `Grade` DB COlumn Name';
$string['mlgrademodinstancefname'] = 'Grade `Module Instance` DB Column Name';
...
$string['mostrecentgrade'] = 'Most Recent Grade';
$string['mostrecentceta'] = 'Most Recent CETA Grade';
...
$string['pagelayout:desc'] = 'The Theme Layout you want to use for the grade tracker';
...
$string['plcalculatetargetgrades'] = 'Calculate Target Grades';
$string['plcalculatetargetgradesdesc'] = 'If selected this will use the average gcse score to calculate and set a Target Grade';
$string['plcalculateaspgrades'] = 'Calculate Aspirational Target Grades';
$string['plcalculateaspgradesdesc'] = 'If selected this will use the target grade to calculate and set an Aspirational Target Grade based upon the settings in the global configuration.';
...
$string['predictedgrade'] = 'Predicted Grade';
...
$string['printreport'] = 'Print Report/Comments';
...
$string['recordsinserted'] = 'Number ofrecords inserted';
$string['refreshregistergroups'] = 'Refresh your Register Groups';
$string['registergroup'] = 'Register Group';
$string['registergroups'] = 'Register Groups';
$string['registergroupimportdesc'] = 'Register Groups are used to create bespoke lists of students to put together in a group, regardless of if they are on different courses or not. This can then be used by the tutor so they can see the list of which students are actually in the classroom with them for that given register event, and view/edit their grids accordingly.';
$string['results'] = 'Results';
$string['removetutorassignments'] = 'Remove Assignments';
$string['reportoptions'] = 'Report Options...';
$string['reportsort'] = 'Report Sort';
...
$string['showbyquals'] = 'Show by My Qualifications';
$string['showbyrole'] = 'Show by role';
$string['showcriteriavalues'] = 'Show Criteria Values';
$string['showqualgradesummary'] = 'Show Qualification Summary Grades';
$string['showstugradesummary'] = 'Show Student Summary Grades';
$string['showqualgradesplitsummary'] = 'Show Qualification Grade Summaries with Split Grades combined.';
$string['showteachingstaff'] = 'Show Teaching Staff';
$string['showtutor'] = 'Show Tutor';
...
$string['specifictargetgradest'] = 'Specific Target (STG)';
$string['status'] = 'Status';
$string['studentchoose'] = 'Students to Choose From';
$string['studentfas'] = 'Student Formal Assessments';
$string['studentprogressdefinitions:predgrade'] = 'Student\'s Predicted Grade needs to meet or exceed their Target Grade.';
...
$string['studentprogress:info:gradetracker:predgrade'] = '%q%: Predicted Grade meets or exceeds Target Grade? (%g%)';
...
$string['targetcoefficients'] = 'Target Qual Coefficients';
$string['targetdate'] = 'Target Date';
$string['targetgrade'] = 'Target Grade';
$string['targetgradetg'] = 'Target Grade (TG)';
$string['targetgrade:desc'] = 'This is your minimum target grade';
...
$string['targetqualweightingwarning'] = 'Please note, for BTECs it is common to give the BTEC Subtypes the same coefficients. These can usually be found in the ALPS reports and given for the overall BTEC VA Score for the provider.';
$string['tasks'] = 'Tasks';
...
$string['unitgroupgrid'] = 'Unit Group Grid';
...
$string['useregistergroups'] = 'Use Register Groups';
$string['useregistergroupsdesc'] = 'This allows you to set up Register Groups of students to view by.';
...
// Y
$string['year'] = 'Year';
$string['yourregistergroups'] = 'Your Register Groups';
