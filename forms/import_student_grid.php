...
if ($qualification && method_exists($qualification, 'import_student_grid')){
    ...
    echo "<p class='c'>";
        echo "<input type='button' class='btn' value='Back to Grid' onclick='window.location.href=\"{$CFG->wwwroot}/blocks/bcgt/grids/studentgrid.php?sID={$studentID}&qID={$qualID}&cID={$courseID}\"' />";
    echo "</p>";
