...
elseif ($grid == 'r')
{
    ...
    if ( file_exists($script) )
    {
        ...
        $out .= "<p><a href='{$CFG->wwwroot}/blocks/bcgt/forms/grid_select.php?g=r&cID={$courseID}&il={$initialLoad}&refresh=1'><img src='".$OUTPUT->pix_url('t/reload')."' alt='refresh' /> ".get_string('refreshregistergroups', 'block_bcgt')."</a></p>";
