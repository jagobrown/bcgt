...
M.mod_bcgtbtec.initunitgrid = function(Y, unitID, qualID, grid, order, freezeCols) {
    ...
    $(document).ready( function(){
        ...
        $('#viewsimple').bind('click', function(){
            ...
            // Get data
            var grid = $('#grid').val();
            var url = M.cfg.wwwroot+"/blocks/bcgt/plugins/bcgtbtec/ajax/get_unit_grid.php?qID="+qualID+"&uID="+unitID+"&g="+grid+"&page="+page+"&order="+order+"&f="+flag+"&cID="+courseID;
        ...
        $('#viewadvanced').bind('click', function(){
            ...
            // Get data
            var grid = $('#grid').val();
            var url = M.cfg.wwwroot+"/blocks/bcgt/plugins/bcgtbtec/ajax/get_unit_grid.php?qID="+qualID+"&uID="+unitID+"&g="+grid+"&page="+page+"&order="+order+"&cID="+courseID;
